...
用复制粘贴的 Markdown 模板，管住 AI 编程任务。

AI 要做大改动时用：加功能、重构、权限、支付、数据迁移、生产逻辑。

**不用安装。不用框架。不用跑服务。就一套模板加一个检查脚本。**
...
| `03-implementation.md` | Worker 记录改了啥 |
| `04-review.md` | Reviewer 审查范围/策略/正确性 |
| `05-sabotage.md` | 反恒真破坏实验记录 |
| `06-handoff.md` | 最终交付总结 |
